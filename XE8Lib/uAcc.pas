...
//type TSQLGetData = procedure(SQL: String) of object;
type TSQLGetInt = function(SQL: String): integer of object;
type TSQLGetStr = function(SQL: String): string of object;
type TSQLGetDte = function(SQL: String): TDateTime of object;
...
type
  ...
  public
    ...
    function GetInt(SQL: string) : Integer;
    function GetStr(SQL: string) : String;
    function GetDte(SQL: string) : TDateTime;
    constructor Create(AExecute:TSQLExec; AGetInt: TSQLGetInt; AGetStr: TSQLGetStr; AGetDte: TSQLGetDte);
  end;
...
type
  ...
  public
    ...
    property Funcs: TFunctions read fFuncs;
    //constructor Create(dExecute:TSQLExec; AccNo: Integer);
    constructor Create(Funcs: TFunctions; AccNo: Integer);
end;
...
constructor TSO.Create(Funcs: TFunctions; AccNo: Integer);
begin
  //fExecute := dExecute;
  fFuncs := Funcs;
  fAccNo:= AccNo;
...
function TSalesOrd_Line.GetDescription: String;
begin
  Result := fStockcode+' Description';
end;
...
constructor TFunctions.Create(AExecute:TSQLExec; AGetInt: TSQLGetInt; AGetStr: TSQLGetStr; AGetDte: TSQLGetDte);
begin
  fExecute := AExecute;
  fGetInt:= AGetInt;
  fGetStr:= AGetStr;
...
procedure TFunctions.Execute(SQL: string);
begin
  fExecute(SQL);
end;

function TFunctions.GetDte(SQL: string): TDateTime;
begin
  Result := fGetDte(SQL);
end;

function TFunctions.GetInt(SQL: string): Integer;
begin
  Result := fGetInt(SQL);
end;

function TFunctions.GetStr(SQL: string): String;
begin
  Result := fGetStr(SQL);
end;
